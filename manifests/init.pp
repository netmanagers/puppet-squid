...
class squid (
  ...
  $icp_port                      = params_lookup( 'icp_port' ),
  $cache_mem                     = params_lookup( 'cache_mem' ),
  $cache_swap_low                = params_lookup( 'cache_swap_low' ),
  $cache_swap_high               = params_lookup( 'cache_swap_high' ),
  $maximum_object_size           = params_lookup( 'maximum_object_size' ),
  $maximum_object_size_in_memory = params_lookup( 'maximum_object_size_in_memory' ),
  $cache_replacement_policy      = params_lookup( 'cache_replacement_policy' ),
  $error_directory               = params_lookup( 'error_directory' ),
  $half_closed_clients           = params_lookup( 'half_closed_clients' ),
  $shutdown_lifetime             = params_lookup( 'shutdown_lifetime' ),
  $buffered_logs                 = params_lookup( 'buffered_logs' ),
  $pipeline_prefetch             = params_lookup( 'pipeline_prefetch' ),
  $client_persistent_connections = params_lookup( 'client_persistent_connections' ),
  $dead_peer_timeout             = params_lookup( 'dead_peer_timeout' ),
  $quick_abort_min               = params_lookup( 'quick_abort_min' ),
  $quick_abort_max               = params_lookup( 'quick_abort_max' ),
  $quick_abort_pct               = params_lookup( 'quick_abort_pct' ),
  $via                           = params_lookup( 'via' ),
  $forwarded_for                 = params_lookup( 'forwarded_for' ),
  $hierarchy_stoplist            = params_lookup( 'hierarchy_stoplist' ),
  $cache_dir                     = params_lookup( 'cache_dir' ),
  $cache_access_log              = params_lookup( 'cache_access_log' ),
  $cache_store_log               = params_lookup( 'cache_store_log' ),
  $ftp_passive                   = params_lookup( 'ftp_passive' ),
  $snmp_port                     = params_lookup( 'snmp_port' ),
  $coredump_dir                  = params_lookup( 'coredump_dir' )
